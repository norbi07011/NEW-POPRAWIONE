## ⚠ ABSOLUTNIE OBOWIĄZKOWE - PRZED JAKĄKOLWIEK ZMIANĄ
...
Po każdej swojej wykonanej pracy w naszej konwersati i dodawaj sekcję: 'RAPORT KOŃCOWY'.  
W raporcie wyjaśniaj jasno i prosto:
1) co zrobiłeś,  
2) co jest teraz OK,  
3) co musimy poprawić,  
4) jakie są kolejne kroki i w jakiej kolejności.  
Zero tłumaczenia o liniach kodu — mów normalnie, ludzkim językiem. tumacz to jak bys tumaczyła dzeciku 5 letniemu 
